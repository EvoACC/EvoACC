...
int main(int argc, char *argv[])
{
	...
	else if (NA == 30000 && NONZER == 12 && NITER == 30 && SHIFT == 20) {

		Class = 'F';

		zeta_verify_value = 19.7905502961915;
	...
	if (t != 0.0) {
		...
		mflops = (double)(2*NITER*NA)
		         * (3.0+(double)(NONZER*(NONZER+1))+ 25.0*(5.0+(double)(NONZER*(NONZER+1)))+ 3.0) / t / 1000000.0;
