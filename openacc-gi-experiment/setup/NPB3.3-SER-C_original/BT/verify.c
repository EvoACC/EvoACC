...
void verify(int no_time_steps, char *Class, logical *verified)
{
  ...
  *verified = true;
  ...
  //---------------------------------------------------------------------
  // reference data for 40x40x40 grids after 200 time steps,
  // with DT = 0.8e-03
  //---------------------------------------------------------------------
  } else if ( (grid_points[0] == 40) && (grid_points[1] == 40) &&
   	      (grid_points[2] == 40) && (no_time_steps == 200) ){
  ...
  *Class = 'F';
  ...
  // Reference values of RMS-norms of residual.
  //---------------------------------------------------------------------
  xcrref[0] = 1.0960203625448E+02;
  xcrref[1] = 1.1483977360936E+01;
  xcrref[2] = 2.6357100190997E+01;
  xcrref[3] = 2.4015371684646E+01;
  xcrref[4] = 2.5658883632239E+02;


  //---------------------------------------------------------------------
  // Reference values of RMS-norms of solution error.
  //---------------------------------------------------------------------
  xceref[0] = 4.2987611790570E+00;
  xceref[1] = 4.5074277206395E-01;
  xceref[2] = 9.8211180019560E-01;
  xceref[3] = 8.9684616308876E-01;
  xceref[4] = 9.8891291349954E+00;
